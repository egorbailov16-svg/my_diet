...
export function MobileBottomNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-50 bg-transparent px-3 pb-3">
      <ul className="mx-auto flex max-w-[430px] gap-1 rounded-[32px] border border-[rgba(255,255,255,0.14)] bg-[rgba(9,14,22,0.72)] px-3 py-3 shadow-[0_22px_48px_rgba(0,0,0,0.58)] backdrop-blur-2xl">
        {navItems.map((item) => {
            ...
            <li key={item.href} className={`flex-1 ${isPrimaryCenter ? "mt-[-18px]" : ""}`}>
              <Link
                ...
                className={[
                  ...
                  isPrimaryCenter ? "mx-auto h-[64px] w-[64px] rounded-full p-0" : "",
                  isActive
                    ? isPrimaryCenter
                      ? "accent-btn scale-[1.03] shadow-[0_0_0_1px_rgba(132,225,75,0.34),0_0_34px_rgba(132,225,75,0.5)]"
                      : "bg-[rgba(132,225,75,0.12)] text-[#8fff70]"
                    : isPrimaryCenter
                      ? "bg-[linear-gradient(180deg,#a5f66f,#84e14b)] text-[#0a1208] shadow-[0_0_0_1px_rgba(132,225,75,0.36),0_0_34px_rgba(132,225,75,0.5)] hover:scale-[1.03]"
